...
public class ReadingFromProperties {
    ...
    public void reading_properties_file() throws Exception{
        ...
        //We need to show where the file is stored/need the path of the fill
        String path = "configuration.properties";
        //    }/Users/heenadhanani-afzal/IdeaProjects/seleniumprojectb18/configuration.properties

        //We need to open configuration.properties file in java memory
